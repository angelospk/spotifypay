...
<footer class="footer absolute inset-x-0 bottom-0 py-0 bg-gray-500 bg-opacity-40 text-white content-center">
	<div class="container text-center text-sm">
	  ...
	  <span class="text-center inset-x-0 text-xs">1. Prompts are randomly generated by ChatGPT.<br>2. Payment is 12€ per 6 months.
	  </span>
	</div>
